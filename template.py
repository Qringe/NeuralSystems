...
dataset = {
    ...
    # I know we shouldn't use the training dataset as validation set, but it's only now that I realized that I need this.
    # Furthermore, it's late and I'm tired. So, forgive me. :)
